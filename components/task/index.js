      ...
      {!editMode ? (
        <>
          <Text style={props.item.completed ? styles.completedTaskText : styles.taskText}>
            {props.item.task + " was completed at " + props.item.completedTime.toDate().toString()}
          </Text>: <Text style={props.item.completed ? styles.completedTaskText : styles.taskText}>
          {props.item.task}
          </Text>
          
          {props.item.completed ? 
           <Icon name="edit" size={0} color="#8B8B8B" />
           :  <TouchableOpacity style={styles.smallIcon} onPress={() => doEdit()}></TouchableOpacity>}
